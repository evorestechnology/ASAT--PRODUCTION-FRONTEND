...
function UserRegister() {
    ...
    const handleGoogleSignup = async () => {
        setError('');
        if (!acceptedTerms) {
            setError('You must accept the Terms & Conditions to sign up with Google.');
            return;
        }
        setLoading(true);
        try {
            ...
            <div className="auth-form-side">
                ...
                <div className="auth-form-container">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', margin: '20px 0' }}>
                        ...
                        <span style={{ margin: '0 10px', fontSize: '0.8rem', color: '#777', fontFamily: 'Inter, sans-serif' }}>OR</span>
                        <div style={{ flex: 1, height: '1px', backgroundColor: '#E5E5E5' }}></div>
                    </div>
